...
static const CGFloat RJAlertViewDefaultTextFontSize = 14;
...
- (void)_labelSetupWithTitle:(NSString*) title andText:(NSString*) text
{
    ...
    _titleLabel.font = [UIFont fontWithName:@"KohinoorDevanagari-Book" size:20.0f];
    ...
    if (self.contentType == RJBlurAlertViewContentTypeText) {
        ...
        _textLabel.font = [UIFont fontWithName:@"KohinoorDevanagari-Book" size:RJAlertViewDefaultTextFontSize];
        _textLabel.textAlignment = NSTextAlignmentCenter;
        _textLabel.lineBreakMode = NSLineBreakByWordWrapping;
        _textLabel.numberOfLines = 0;
        _textLabel.textColor = [UIColor colorWithRed:0.176f green:0.243f blue:0.310f alpha:1.00f];
...
- (void)_buttonSetupWithCancelButton:(BOOL) hasCancelButton
{
    ...
    if (hasCancelButton) {
        ...
        _cancelButton.backgroundColor = [UIColor colorWithRed:0.922f green:0.294f blue:0.239f alpha:1.00f];
        
        [_cancelButton setTitle:@"取消" forState:UIControlStateNormal];
        _cancelButton.titleLabel.textColor = [UIColor whiteColor];
        _cancelButton.titleLabel.font = [UIFont fontWithName:@"KohinoorDevanagari-Book" size:18.0f];
    ...
    _okButton.titleLabel.font = [UIFont fontWithName:@"KohinoorDevanagari-Book" size:18.0f];
...
{
    UIFont *font = [UIFont fontWithName:@"KohinoorDevanagari-Book" size:RJAlertViewDefaultTextFontSize];
