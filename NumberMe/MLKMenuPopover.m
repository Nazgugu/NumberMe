...
#define MENU_POINTER_RECT       CGRectMake(frame.origin.x + frame.size.width - 38, frame.origin.y, 23, 11)
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell == nil)
    {
        ...
        [cell.textLabel setFont:[UIFont fontWithName:@"KohinoorDevanagari-Book" size:FONT_SIZE]];
